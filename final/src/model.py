    ...
    def __init__(self, inputs=None, outputs=None,
        ...
        for i in range(3):
            uP = Bidirectional(GRU(units=H,
                                   ...
                                   unroll=unroll)) (uP)
        uP = VariationalDropout(rate=dropout_rate, noise_shape=(-1, 1, 2 * H), name='uP') (uP)
        ...
        for i in range(3):
            uQ = Bidirectional(GRU(units=H,
                                   ...
                                   dropout=dropout_rate,
                                   unroll=unroll)) (uQ)
        uQ = VariationalDropout(rate=dropout_rate, noise_shape=(-1, 1, 2 * H), name='uQ') (uQ)
        ...
        vP = VariationalDropout(rate=dropout_rate, noise_shape=(-1, 1, H), name='vP') (vP)
        ...
        hP = VariationalDropout(rate=dropout_rate, noise_shape=(-1, 1, 2 * H), name='hP') (hP)
